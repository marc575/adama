...
class XbetController extends AbstractController
{
    ...
    public function depot(Request $request, ManagerRegistry $doctrine, MailerInterface $mailer) : Response
    {
        ...
        if($request->isMethod(Request::METHOD_POST)) 
        {
            ...
            return $this->redirect('https://wa.me/2250708618478?param=id_compte%3D%20%24id_compte%20montant%3D%20%24montant%20id_transaction%3D%20%24id_transaction%20numero_paiement%3D%20%24numero_paiement%20pays%3D%20%24pays');
        }
